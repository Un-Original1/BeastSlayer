...
public class RenderBeam extends Render<EntityBeam> {
    ...
    private static final ResourceLocation GOOD = new ResourceLocation("ancientbeasts:textures/particles/particle_shielded.png");
    private static final ResourceLocation EVIL = new ResourceLocation("ancientbeasts:textures/particles/particle_shielded_evil.png");
    ...
    {
        return entity.buffedEntity != null ? EVIL : GOOD;
    }
