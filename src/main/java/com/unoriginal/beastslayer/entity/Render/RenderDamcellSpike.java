...
import com.unoriginal.beastslayer.entity.Entities.EntityDamcellSpike;
...
public class RenderDamcellSpike extends Render<EntityDamcellSpike> {
    ...
    protected RenderDamcellSpike(RenderManager renderManager) {
        super(renderManager);
    }
    public void doRender(EntityDamcellSpike entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityDamcellSpike entity) {
        return TEXTURE;
    }

    public static class Factory implements IRenderFactory<EntityDamcellSpike> {

        @Override
        public Render<? super EntityDamcellSpike> createRenderFor(RenderManager manager) {
            return new RenderDamcellSpike(manager);
        }
