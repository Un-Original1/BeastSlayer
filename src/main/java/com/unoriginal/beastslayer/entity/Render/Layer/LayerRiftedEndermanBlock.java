...
import com.unoriginal.beastslayer.entity.Render.RenderRiftedEnderman;
...
public class LayerRiftedEndermanBlock implements LayerRenderer<EntityRiftedEnderman>
{
    private final RenderRiftedEnderman endermanRenderer;

    public LayerRiftedEndermanBlock(RenderRiftedEnderman endermanRendererIn)
    {
