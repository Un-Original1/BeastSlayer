...
//Friendlier version of entity projectile generic
public abstract class EntityProjectileFireball2 extends Entity
{
    ...
    public EntityProjectileFireball2(World worldIn)
    {
        super(worldIn);
    ...
    public EntityProjectileFireball2(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityProjectileFireball2(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
