...
import com.unoriginal.beastslayer.entity.Entities.ai.EntityAIPatrol;
...
public class EntityLilVessel extends EntityTameable implements IRangedAttackMob{
    ...
    public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand)
    {
        ...
        if(this.isTamed() && player == this.getOwner() && player.isSneaking()){
            ...
            if(itemstack.getItem() == Items.GUNPOWDER && !this.shouldKillPlayer()  && !world.isRemote){
                ...
                if(!player.capabilities.isCreativeMode && BeastSlayerConfig.shouldVesselConsumeItem) {
                    itemstack.shrink(1);
                }
    ...
    {
        List blacklist_items = Arrays.asList(BeastSlayerConfig.lil_v_blacklist);
        ResourceLocation item_name = stack.getItem().getRegistryName();
