...
public class ModelEarthling extends ModelBase {
	...
	public ModelEarthling( float scale) {
		textureWidth = 64;
		textureHeight = 64;

		leg_r = new ModelRenderer(this);
		leg_r.setRotationPoint(-4.5F, 18.0F, 0.5F);
		leg_r.cubeList.add(new ModelBox(leg_r, 0, 40, -2.5F, 0.0F, -2.5F, 5, 6, 5, scale, false));

		leg_l = new ModelRenderer(this);
		leg_l.setRotationPoint(4.5F, 18.0F, 0.5F);
		leg_l.cubeList.add(new ModelBox(leg_l, 32, 30, -2.5F, 0.0F, -2.5F, 5, 6, 5, scale, true));

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, 18.0F, 0.0F);
		head.cubeList.add(new ModelBox(head, 0, 0, -9.0F, -16.0F, -7.0F, 18, 16, 14, scale, false));
		head.cubeList.add(new ModelBox(head, 0, 30, 1.0F, -18.0F, -1.0F, 8, 2, 8, scale, false));
	}
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.head.rotateAngleZ = MathHelper.cos(limbSwing * 1.3F) * 2F * limbSwingAmount;
        ...
        this.head.rotationPointY = 18F + MathHelper.cos(ageInTicks * 0.2F) * 0.2F;

        this.leg_l.rotationPointY =  18F + MathHelper.cos(limbSwing * 1.8F) * 4F * limbSwingAmount;
        this.leg_r.rotationPointY =  18F + MathHelper.cos(limbSwing * 1.8F + (float)Math.PI) * 4F * limbSwingAmount ;


        this.leg_l.rotationPointZ =  0F - MathHelper.cos(limbSwing * 1.8F+ (float)Math.PI) * 6F * limbSwingAmount;
        this.leg_r.rotationPointZ =  0F - MathHelper.cos(limbSwing * 1.8F)  * 6F * limbSwingAmount ;
