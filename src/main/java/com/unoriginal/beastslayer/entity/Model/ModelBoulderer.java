package com.unoriginal.beastslayer.entity.Model;// Made with Blockbench 4.1.1
...
public class ModelBoulderer extends ModelBiped {
	...
	public ModelBoulderer(float modelSize, boolean is32) {
		...
		bipedHead.cubeList.add(new ModelBox(bipedHead, 10, 48, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.25F, false));
