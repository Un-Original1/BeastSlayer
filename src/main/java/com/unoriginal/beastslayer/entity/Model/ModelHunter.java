...
public class ModelHunter extends ModelBase {
	...
	public ModelHunter() {
		...
		body.cubeList.add(new ModelBox(body, 0, 53, -3.0F, -3.0F, -2.0F, 6, 7, 4, 0.5F, false));
		body.cubeList.add(new ModelBox(body, 1, 45, -3.0F, -10.0F, -1.5F, 6, 4, 3, 0.25F, false));
		body.cubeList.add(new ModelBox(body, 1, 33, -3.0F, -10.0F, -1.5F, 6, 9, 3, 0.0F, false));

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -10.0F, 0.0F);
		body.addChild(head);
		head.cubeList.add(new ModelBox(head, 33, 8, -4.0F, -8.0F, -3.0F, 8, 8, 7, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 44, 40, -3.0F, -9.0F, -5.0F, 6, 4, 4, 0.1F, false));

		hood = new ModelRenderer(this);
		hood.setRotationPoint(0.0F, 0.0F, 0.0F);
		head.addChild(hood);
		hood.cubeList.add(new ModelBox(hood, 34, 25, -4.0F, -8.0F, -3.0F, 8, 8, 7, 0.45F, false));
		hood.cubeList.add(new ModelBox(hood, 0, 8, -3.0F, -9.0F, -4.0F, 6, 2, 3, 0.5F, false));

		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, -7.0F, 5.0F);
		hood.addChild(bone);
		setRotationAngle(bone, -0.7854F, 0.0F, 0.0F);
		bone.cubeList.add(new ModelBox(bone, 40, 4, -3.0F, -0.3864F, -1.1642F, 6, 2, 2, 0.25F, false));

		horn0 = new ModelRenderer(this);
		horn0.setRotationPoint(-4.0F, -7.0F, 3.0F);
		head.addChild(horn0);
		horn0.cubeList.add(new ModelBox(horn0, 17, 37, -2.0F, 4.0F, -1.0F, 3, 0, 3, 0.0F, false));
		horn0.cubeList.add(new ModelBox(horn0, 25, 40, -2.0F, -2.0F, -1.0F, 3, 8, 3, 0.0F, false));

		horn1 = new ModelRenderer(this);
		horn1.setRotationPoint(4.0F, -7.0F, 3.0F);
		head.addChild(horn1);
		horn1.cubeList.add(new ModelBox(horn1, 17, 37, -1.0F, 4.0F, -1.0F, 3, 0, 3, 0.0F, true));
		horn1.cubeList.add(new ModelBox(horn1, 25, 40, -1.0F, -2.0F, -1.0F, 3, 8, 3, 0.0F, true));

		mask = new ModelRenderer(this);
		mask.setRotationPoint(0.0F, -4.0F, -3.0F);
		head.addChild(mask);
		mask.cubeList.add(new ModelBox(mask, 23, 52, -5.0F, -5.0F, -1.0F, 10, 10, 1, 0.0F, false));
		mask.cubeList.add(new ModelBox(mask, 1, 0, -8.0F, -4.0F, 0.01F, 16, 8, 0, 0.0F, false));

		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(3.0F, -9.0F, 0.0F);
		body.addChild(LeftArm);
		LeftArm.cubeList.add(new ModelBox(LeftArm, 46, 52, 0.0F, -1.0F, -1.0F, 2, 9, 2, 0.0F, false));

		RightArm = new ModelRenderer(this);
		body.addChild(RightArm);
		RightArm.setRotationPoint(-3.0F, -9.0F, 0.0F);
		RightArm.cubeList.add(new ModelBox(RightArm, 46, 52, -2.0F, -1.0F, -1.0F, 2, 9, 2, 0.0F, true));

		cloak = new ModelRenderer(this);
		cloak.setRotationPoint(0.0F, -10.0F, 1.0F);
		body.addChild(cloak);
		cloak.cubeList.add(new ModelBox(cloak, 0, 14, -5.0F, 0.0F, -3.0F, 10, 14, 4, 0.51F, false));

		tail = new ModelRenderer(this);
		tail.setRotationPoint(0.0F, -2.0F, 1.5F);
		body.addChild(tail);
		tail.cubeList.add(new ModelBox(tail, 39, -6, 0.0F, 0.0F, -0.5F, 0, 1, 8, 0.0F, false));

		art1 = new ModelRenderer(this);
		art1.setRotationPoint(0.0F, 0.5F, 7.0F);
		tail.addChild(art1);
		art1.cubeList.add(new ModelBox(art1, 39, -7, -0.001F, -0.5F, -0.5F, 0, 1, 8, 0.0F, false));

		point = new ModelRenderer(this);
		point.setRotationPoint(0.0F, 0.0F, 7.5F);
		art1.addChild(point);
		point.cubeList.add(new ModelBox(point, 50, 8, -2.0F, 0.0F, -1.0F, 4, 0, 6, 0.0F, false));

		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(2.0F, 15.0F, 0.0F);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 56, 53, -1.0F, 0.0F, -1.0F, 2, 9, 2, 0.0F, true));

		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-2.0F, 15.0F, 0.0F);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 56, 53, -1.0F, 0.0F, -1.0F, 2, 9, 2, 0.0F, false));
	}
