...
public class ModelGiant extends ModelBase {
	...
	public ModelGiant() {
		...
		body.cubeList.add(new ModelBox(body, 0, 81, -15.0F, -30.0F, -8.0F, 30, 30, 17, 0.1F, false));

		body_upper = new ModelRenderer(this);
		body_upper.setRotationPoint(0.0F, -18.0F, 0.0F);
		body.addChild(body_upper);
		body_upper.cubeList.add(new ModelBox(body_upper, 0, 0, -21.0F, -28.0F, -13.5F, 42, 28, 27, 0.0F, false));

		armRight = new ModelRenderer(this);
		armRight.setRotationPoint(-21.0F, -20.0F, 0.0F);
		body_upper.addChild(armRight);
		armRight.cubeList.add(new ModelBox(armRight, 192, 0, -16.0F, -10.0F, -8.5F, 16, 60, 16, 0.0F, false));

		armLeft = new ModelRenderer(this);
		armLeft.setRotationPoint(21.0F, -20.0F, 0.0F);
		...
		head.setRotationPoint(0.0F, -28.0F, -9.0F);
		body_upper.addChild(head);
		head.cubeList.add(new ModelBox(head, 133, 46, -7.0F, -14.0F, -7.0F, 14, 14, 14, 0.0F, false));
