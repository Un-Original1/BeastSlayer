...
public class EntityDamcell extends EntityMob implements IRangedAttackMob {
    public static final ResourceLocation LOOT = new ResourceLocation(AncientBeasts.MODID, "entities/Damcell");
            ...
            if(rand.nextInt(5) == 0 ){
                ...
                if(!list.isEmpty()) {
                    ...
                    for(EntityLivingBase livingBase : list){
                        if((livingBase instanceof EntityPlayer || livingBase instanceof EntityTameable) && this.suckTimer > 0) {
        ...
        if(this.isBeingRidden()){
            for(Entity e : this.getPassengers())
            {
                if(e instanceof EntityLivingBase && !world.isRemote) {
                    ...
                    l.attackEntityFrom(DamageSource.causeMobDamage(this).setDamageBypassesArmor(), 2.0F);
