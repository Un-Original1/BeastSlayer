...
public class EntityAIUseBow<T extends EntityCreature & IRangedAttackMob> extends EntityAIBase {
    ...
    public EntityAIUseBow(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn)
    {
        this.entity = mob;
