...
public class EntityFakeDuplicate extends EntitySpellcasterIllager {
    ...
    public void onUpdate() {
        ...
        if(this.limitedLifespan && --this.lifeTicks <= 0){
            this.attackEntityFrom(DamageSource.MAGIC, 1.0F);
        }
        if(this.getCreator() == null || this.world.isDaytime()){
            this.attackEntityFrom(DamageSource.MAGIC, 1.0F);
        }
    }
    ...
    public EntityVessel getCreator(){return this.creator;}
    public void setCreator(EntityVessel vessel){this.creator = vessel;}
}
